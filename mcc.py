...
def linear_disentanglement(z, hz, mode: __Mode = "r2", train_test_split=False):
    ...
    return inner_result, (z_2, hz_2), model.coef_, model.intercept_
...
def calc_disent_metrics(z, hz):
    ...
    return {
        "lin_dis_score": lin_dis_score,
        "lin_coef_mat": coef_,
        "lin_intercept": intercept_,
        "permutation_disentanglement_score": permutation_disentanglement_score,
        "perm_corr_mat": perm_corr_mat,
        "munkres_sort_idx": munkres_sort_idx,
    }
